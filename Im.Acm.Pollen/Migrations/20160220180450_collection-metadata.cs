...
{
    public partial class collectionmetadata : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_AppUser_UserId", table: "AspNetUserRoles");
            migrationBuilder.DropForeignKey(name: "FK_Grain_AppUser_SubmittedById", table: "Grain");
            migrationBuilder.DropColumn(name: "ContactEmail", table: "ReferenceCollection");
            migrationBuilder.DropColumn(name: "WebAddress", table: "ReferenceCollection");
            migrationBuilder.AlterColumn<string>(
                name: "FocusRegion",
                table: "ReferenceCollection",
                nullable: false);
