...
{
    public partial class referencecollection1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "ReferenceCollectionId", table: "ReferenceGrain");
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReferenceCollection", x => x.Id);
                });
            ...
            migrationBuilder.AddForeignKey(
                ...
                onDelete: ReferentialAction.Cascade);
            migrationBuilder.AddForeignKey(
                name: "FK_ReferenceGrain_ReferenceCollection_CollectionId",
                table: "ReferenceGrain",
                column: "CollectionId",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_AppUser_UserId", table: "AspNetUserRoles");
            migrationBuilder.DropForeignKey(name: "FK_Grain_AppUser_SubmittedById", table: "Grain");
            migrationBuilder.DropForeignKey(name: "FK_ReferenceGrain_ReferenceCollection_CollectionId", table: "ReferenceGrain");
            migrationBuilder.DropColumn(name: "CollectionId", table: "ReferenceGrain");
            migrationBuilder.DropTable("ReferenceCollection");
