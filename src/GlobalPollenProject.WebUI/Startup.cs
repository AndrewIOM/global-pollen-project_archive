...
using GlobalPollenProject.WebUI.Services.Concrete;
using System.IO;
...
namespace GlobalPollenProject.WebUI
{
    public class Startup
    {
        ...
        private void EnsureAdminUser(IApplicationBuilder app)
        {
            ...
            var organisation = context.Organisations.FirstOrDefaultAsync(m => m.Name == "GPP Admin").Result;
